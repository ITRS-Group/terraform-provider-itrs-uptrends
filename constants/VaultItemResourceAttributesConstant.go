...
var VaultItemResourceAttributes = map[string]helpers.ResourceAttributes{
	"CredentialSet": {
		...
		OptionalAttributes: append([]string{"password_wo", "username"}, allVaultItemAttributes...), // The password_wo is optional for the Update
	},
	"Certificate": {
		RequiredAttributes: []string{},
		OptionalAttributes: append([]string{"value_wo"}, allVaultItemAttributes...), // The value is optional for the Update
	},
	"CertificateArchive": {
		RequiredAttributes: []string{},
...
var VaultItemResourceAttributesCreate = map[string]helpers.ResourceAttributes{
	"CredentialSet": {
		...
		OptionalAttributes: append([]string{"username"}, allVaultItemAttributes...),
	},
	"Certificate": {
