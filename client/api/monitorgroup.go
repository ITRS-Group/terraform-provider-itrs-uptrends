...
func (c *MonitorGroupClient) GetMonitorGroups() ([]models.MonitorGroupResponse, int, string, error) {
	...
	if !resp.IsSuccess() {
		return nil, statusCode, responseBody, fmt.Errorf("failed to list monitor groups: %s", resp.Status())
	}
