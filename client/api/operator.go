...
func (a *Operator) UpdateOperator(operatorID string, requestBody models.OperatorUpdateRequest) (int, string, error) {
...
func (a *Operator) GetOperator(operatorID string) (*models.OperatorGetResponse, int, error, string) {
	var operator models.OperatorGetResponse
