...
// CheckpointURL returns the full URL for the Checkpoint endpoint.
func (c *UrlSource) CheckpointURL() string {
	return c.baseURL + "/Checkpoint"
}

// CheckpointRegionURL returns the full URL for the CheckpointRegion endpoint.
func (c *UrlSource) CheckpointRegionURL() string {
	return c.baseURL + "/CheckpointRegion"
}
...
// RumWebsiteURL returns the full URL for the RumWebsite endpoint.
func (c *UrlSource) RumWebsiteURL() string {
	return c.baseURL + "/Rum/Website"
}
