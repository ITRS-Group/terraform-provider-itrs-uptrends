...
func buildProvidedAttributes(config interface{}) ([]string, bool) {
	var providedAttrs []string
	var hasUnknown bool
	hasUnknown = false // We use this field to indicate if any of the attributes are unknown in order to skip the validation during the validate stage.
	...
	return providedAttrs, hasUnknown
}
