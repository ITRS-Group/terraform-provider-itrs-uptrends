...
type CertificateArchiveModelDataSource struct {
	Issuer    types.String `tfsdk:"issuer"`
	NotBefore types.String `tfsdk:"not_before"`
	NotAfter  types.String `tfsdk:"not_after"`
}
type OneTimePasswordModelDataSource struct {
	Digits        types.Int64  `tfsdk:"digits"`
	Period        types.Int64  `tfsdk:"period"`
	HashAlgorithm types.String `tfsdk:"hash_algorithm"`
}
type VaultItemResourceModelDataSource struct {
	ID                 types.String                       `tfsdk:"id"`
	Name               types.String                       `tfsdk:"name"`
	VaultSectionID     types.String                       `tfsdk:"vault_section_id"`
	VaultItemType      types.String                       `tfsdk:"vault_item_type"`
	Notes              types.String                       `tfsdk:"notes"`
	UserName           types.String                       `tfsdk:"username"`
	CertificateArchive *CertificateArchiveModelDataSource `tfsdk:"certificate_archive"`
	File               *FileModel                         `tfsdk:"file"`
	OneTimePassword    *OneTimePasswordModelDataSource    `tfsdk:"one_time_password"`
}
