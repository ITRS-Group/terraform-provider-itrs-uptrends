...
type UptrendsProvider struct {
	...
	alertDefinitionMonitorGroupMembership  *api.AlertDefinitionMonitorGroupMembership
	monitor                                *api.Monitor
	...
	vaultSectionPermission                 *api.VaultSectionPermission
	rumWebsite                             *api.RumWebsite
	escalationLevelIntegration             *api.EscalationLevelIntegration
}
...
func (p *UptrendsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	...
	resp.Version = strings.ReplaceAll(constants.NewBuildVersion, "__NEW_BUILD_VERSION__", "1.0.0")
}
...
func (p *UptrendsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	p.operator = api.NewOperator(urlSource.OperatorURL(), header, constants.NewBuildVersion, platform)
	p.operatorGroup = api.NewOperatorGroup(urlSource.OperatorGroupURL(), header, constants.NewBuildVersion, platform)
	p.membership = api.NewMembership(urlSource.OperatorGroupURL(), header, constants.NewBuildVersion, platform)
	p.monitor = api.NewMonitorClient(header, urlSource.MonitorURL(), constants.NewBuildVersion, platform)
	p.monitorGroup = api.NewMonitorGroupClient(urlSource.MonitorGroupURL(), header, constants.NewBuildVersion, platform)
	...
	p.alertDefinitionMonitorGroupMembership = api.NewAlertDefinitionMonitorGroupMembership(urlSource.AlertDefinitionURL(), header, constants.NewBuildVersion, platform)
	...
	p.operatorPermission = api.NewOperatorPermission(urlSource.OperatorURL(), header, constants.NewBuildVersion, platform)
	p.vaultItem = api.NewVaultItem(urlSource.VaultItemURL(), header, constants.NewBuildVersion, platform)
	p.vaultSection = api.NewVaultSection(urlSource.VaultSectionURL(), header, constants.NewBuildVersion, platform)
	p.vaultSectionPermission = api.NewVaultSectionPermission(urlSource.VaultSectionURL(), header, constants.NewBuildVersion, platform)
	p.checkpoint = api.NewCheckpoint(urlSource.CheckpointURL(), urlSource.CheckpointRegionURL(), header, constants.NewBuildVersion, platform)
	p.rumWebsite = api.NewRumWebsite(urlSource.RumWebsiteURL(), header, constants.NewBuildVersion, platform)
	p.escalationLevelIntegration = api.NewEscalationLevelIntegration(urlSource.AlertDefinitionURL(), header, constants.NewBuildVersion, platform)
}
...
func (p *UptrendsProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		p.createAlertDefinitionMonitorGroupMembershipResource,
		...
		p.createVaultSectionPermissionResource,
		p.createRumWebsiteResource,
		p.createEscalationLevelIntegrationResource,
	}
}

// DataSources defines the data sources implemented in the provider.
func (p *UptrendsProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		p.createOperatorDataSource,
		p.createMonitorDataSource,
		p.createOperatorGroupDataSource,
		p.createMonitorGroupDataSource,
		p.createAlertDefinitionDataSource,
		p.createVaultItemDataSource,
		p.createVaultSectionDataSource,
		p.createCheckpointDataSource,
		p.createCheckpointRegionDataSource,
		p.createRumWebsiteDataSource,
	}
}
...
func (p *UptrendsProvider) createAlertDefinitionMonitorGroupMembershipResource() resource.Resource {
	return NewAlertDefinitionMonitorGroupMembershipResource(p.alertDefinitionMonitorGroupMembership)
}
...
func (p *UptrendsProvider) createOperatorResource() resource.Resource {
	return NewOperatorResource(p.operator)
}
...
func (p *UptrendsProvider) createOperatorDataSource() datasource.DataSource {
	return NewOperatorDataSource(p.operator)
}

func (p *UptrendsProvider) createMonitorDataSource() datasource.DataSource {
	return NewMonitorDataSource(p.monitor)
}

func (p *UptrendsProvider) createOperatorGroupDataSource() datasource.DataSource {
	return NewOperatorGroupDataSource(p.operatorGroup)
}

func (p *UptrendsProvider) createMonitorGroupDataSource() datasource.DataSource {
	return NewMonitorGroupDataSource(p.monitorGroup)
}

func (p *UptrendsProvider) createAlertDefinitionDataSource() datasource.DataSource {
	return NewAlertDefinitionDataSource(p.alertDefinition)
}

func (p *UptrendsProvider) createVaultItemDataSource() datasource.DataSource {
	return NewVaultItemDataSource(p.vaultItem)
}

func (p *UptrendsProvider) createVaultSectionDataSource() datasource.DataSource {
	return NewVaultSectionDataSource(p.vaultSection)
}

func (p *UptrendsProvider) createCheckpointDataSource() datasource.DataSource {
	return NewCheckpointDataSource(p.checkpoint)
}

func (p *UptrendsProvider) createCheckpointRegionDataSource() datasource.DataSource {
	return NewCheckpointRegionDataSource(p.checkpoint)
}

func (p *UptrendsProvider) createRumWebsiteDataSource() datasource.DataSource {
	return NewRumWebsiteDataSource(p.rumWebsite)
}
...
func (p *UptrendsProvider) createVaultSectionPermissionResource() resource.Resource {
	return NewVaultSectionPermissionResource(p.vaultSectionPermission)
}

func (p *UptrendsProvider) createRumWebsiteResource() resource.Resource {
	return NewRumWebsiteResource(p.rumWebsite)
}

func (p *UptrendsProvider) createEscalationLevelIntegrationResource() resource.Resource {
	return NewEscalationLevelIntegrationResource(p.escalationLevelIntegration)
}
