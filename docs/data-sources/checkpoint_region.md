...
### Read-Only
- `selected_regions_ids` (List of Number) IDs of the matching regions.  This list is sorted and when used within the `itrs-uptrends_monitor` is going to be compatible with the result of the API to avoid configuration-state inconsistency.
