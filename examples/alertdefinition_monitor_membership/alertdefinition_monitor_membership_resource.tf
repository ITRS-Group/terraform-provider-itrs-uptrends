# To assign a monitor to an alert definition, you need first to create both the alert definition and the itrs-uptrends_monitor. Then, you can create a `itrs-uptrends_alertdefinition_monitor_membership` resource that links the two.
