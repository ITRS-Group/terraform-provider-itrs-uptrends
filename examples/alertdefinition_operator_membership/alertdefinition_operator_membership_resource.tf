# To assign an operator to an alertdefinition, you need first to create both the alertdefinition and the operator. Then, you can create an `itrs-uptrends_alertdefinition_operator_membership` resource that links the two.
