...
resource "itrs-uptrends_alertdefinition_operatorgroup_membership" "alertdefinition_operatorgroup_membership123" {
...
import {
  to = itrs-uptrends_alertdefinition_operatorgroup_membership.alertdefinition_operatorgroup_membership_imported
